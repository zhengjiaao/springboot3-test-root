...
import com.zja.api.openapi.security.model.UserDTO;
import com.zja.api.openapi.security.model.UserExtensionDTO;
...
@CrossOrigin
@Tag(name = "提供Rest接口", description = "提供远程-Rest测试接口")
@RestController
@RequestMapping
...
public class WebRestController {
    ...
    public Object postObject(@Parameter(description = "传参值：name") @RequestParam String name,
                             @Parameter(description = "传参值：age") @RequestParam String age) {
